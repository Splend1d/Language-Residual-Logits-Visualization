...
input_path = "assets/phi4-multimodal-noaudiowithlora-from-phi4-multimodal.jsonl"           # <- change this
output_path = "assets/phi4-multimodal-noaudiowithlora-from-phi4-multimodal.logscale.jsonl"  # <- change this
